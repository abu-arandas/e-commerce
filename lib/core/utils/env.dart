...
abstract final class Env {
  ...
  static final double flatShippingFee = double.parse(
      const String.fromEnvironment('FLAT_SHIPPING_FEE', defaultValue: "12.0"));

  /// Free-shipping threshold used for storefront messaging.
  static final double freeShippingThreshold = double.parse(
      const String.fromEnvironment('FREE_SHIPPING_THRESHOLD',
          defaultValue: "150.0"));
