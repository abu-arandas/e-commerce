...
abstract final class Env {
  ...
  static final double flatShippingFee = double.tryParse(
          const String.fromEnvironment('FLAT_SHIPPING_FEE',
              defaultValue: '12.0')) ??
      12.0;

  /// Free-shipping threshold used for storefront messaging.
  static final double freeShippingThreshold = double.tryParse(
