        ...
        children: [
          ClipRRect(
            ...
            child: SizedBox(
              width: 84,
              height: 108,
              child: VfImage(url: line.imageUrl),
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(
                    context,
                  ).textTheme.labelSmall?.copyWith(color: AppColors.mist),
                ),
            ...
            if (cart.amountToFreeShipping > 0) ...[
              ...
              ClipRRect(
                ...
                child: LinearProgressIndicator(
                  value:
                      (cart.subtotal /
                              StoreSettings.freeShippingThreshold.value)
                          .clamp(0, 1)
                          .toDouble(),
                  minHeight: 6,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        cart.appliedPromo.value?.description ?? 'Promo applied',
