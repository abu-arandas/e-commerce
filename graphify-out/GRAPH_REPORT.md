...
## Corpus Check
- 98 files · ~55,534 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1315 nodes · 1823 edges · 90 communities (69 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dd69b0dd`
...
- `CartController` --inherits--> `GetxController`  [EXTRACTED]
  lib/controllers/cart_controller.dart → None  _Bridges community 13 → community 24_
- `CatalogController` --inherits--> `GetxController`  [EXTRACTED]
  lib/controllers/catalog_controller.dart → None  _Bridges community 13 → community 25_
...
- `AdminOrdersView` --inherits--> `StatelessWidget`  [EXTRACTED]
  lib/views/admin/admin_orders_view.dart → None  _Bridges community 36 → community 43_
- `_AccessDenied` --inherits--> `StatelessWidget`  [EXTRACTED]
  lib/views/admin/admin_scaffold.dart → None  _Bridges community 36 → community 29_
...
Cohesion: 0.24
Nodes (10): Bindings, ../../controllers/admin_controller.dart, ../../controllers/cart_controller.dart, GetxController, AdminController, AuthController, OrdersController, WishlistController (+2 more)
...
Cohesion: 0.14
Nodes (16): package:flutter_test/flutter_test.dart, package:vanguard_fashion/controllers/admin_controller.dart, package:vanguard_fashion/controllers/cart_controller.dart, package:vanguard_fashion/models/order_model.dart, package:vanguard_fashion/models/product_model.dart, package:vanguard_fashion/models/variant_model.dart, package:vanguard_fashion/views/storefront/order_confirmation_view.dart, main (+8 more)
...
Cohesion: 0.12
Nodes (14): dart:convert, CartController, Product, package:vanguard_fashion/core/utils/env.dart, package:vanguard_fashion/core/utils/store_settings.dart, cart, lineFor, main (+6 more)

### Community 25 - "wishlist_test.dart"
Cohesion: 0.11
Nodes (17): CatalogController, package:vanguard_fashion/controllers/auth_controller.dart, package:vanguard_fashion/controllers/catalog_controller.dart, package:vanguard_fashion/controllers/wishlist_controller.dart, package:vanguard_fashion/core/utils/demo_data.dart, package:vanguard_fashion/views/shared/variant_selector.dart, knitwear, main (+9 more)

### Community 26 - "package:get/get.dart"
Cohesion: 0.09
Nodes (21): ../../controllers/catalog_controller.dart, ../../core/utils/seo/seo_service.dart, _AnnouncementBar, build, _CategoryStrip, _cats, _EditorialBand, _Hero (+13 more)
...
Cohesion: 0.18
Nodes (10): ../../controllers/auth_controller.dart, ../../controllers/orders_controller.dart, ../../controllers/wishlist_controller.dart, AccountView, build, createState, initState, orders (+2 more)

### Community 39 - "orders_controller_test.dart"
Cohesion: 0.40
Nodes (4): package:vanguard_fashion/controllers/orders_controller.dart, main, order, orders
...
### Community 43 - "admin_orders_view.dart"
Cohesion: 0.11
Nodes (18): admin_scaffold.dart, ../../core/utils/bootstrap5.dart, ../../core/utils/formatters.dart, Order, OrderStatus, admin, AdminOrdersView, build (+10 more)
...
Cohesion: 0.12
Nodes (15): ../../core/routes/app_routes.dart, ../../core/theme/app_spacing.dart, build, createState, _hover, product, _swatches, _tag (+7 more)
...
## Knowledge Gaps
- **813 isolated node(s):** `LowStockEntry`, `productTitle`, `colorName`, `sizeLabel`, `sku` (+808 more)
...
- **Why does `CartController` connect `cart_test.dart` to `Cart Controller Test Fakes`, `Cart View & Order Summary`, `Product Detail View`, `Cart Controller`, `checkout_view.dart`, `initial_binding.dart`, `Storefront Scaffold`, `Custom App Bar`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `AuthController` connect `initial_binding.dart` to `Routing & Access Guards`, `login_view.dart`, `account_view.dart`, `checkout_view.dart`, `auth_controller.dart`, `Auth Controller Tests`, `wishlist_test.dart`, `wishlist_controller.dart`, `Admin Scaffold Navigation`, `Custom App Bar`?**
